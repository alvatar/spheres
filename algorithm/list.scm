...
;;;
;;; Copyright (c) 2012 by Álvaro Castro-Castilla (modifications)
...
;;! Recursively cons all elements given as arguments
...
;;! A proper list is made of consing elements to a final empty list
