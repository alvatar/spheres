...
(define* (time-utc->date time (tz-offset 0))
...
(define* (julian-day->date jdn (tz-offset tm:local-tz-offset))
...
(define* (modified-julian-day->date jdn (tz-offset tm:local-tz-offset))
...
(define* (date->string date (fmt-str "~c"))
