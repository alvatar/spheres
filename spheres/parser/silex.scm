...
;;; File: "silex.scm", Time-stamp: <2007-09-30 18:09:51 feeley>

;;; Copyright (c) 1997 by Danny Dubé, Université de Montréal, All
;;; Rights Reserved.

;;;============================================================================

;; The SILex lexical analyzer generator.
...
(define (lex filein fileout . options)
...
(define (lex-tables filein table-name fileout . options)
